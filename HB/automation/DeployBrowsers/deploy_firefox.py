...
def deploy_firefox(status_queue, browser_params, manager_params,
    ...
    ####ADDED THIS PROXY####
    # server = Server('/home/johncook/headerBidding/TrackingProject/src/browsermob-proxy-2.1.4/bin/browsermob-proxy')
    # server.start()
    ...
    return driver, interceptor.profile_path, profile_settings#, proxy, server
