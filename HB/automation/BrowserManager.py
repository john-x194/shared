...
def BrowserManager(command_queue, status_queue, browser_params,
    ...
    try:
        ...
        # driver, prof_folder, browser_settings,proxy, server = deploy_browser.deploy_browser(
        ...
        while True:
            ...
            if command[0] == 'GET': 
                ...
                #     browser_params, manager_params, extension_socket, proxy=proxy, server=server)
                command_executor.execute_command(
                    command, driver, browser_settings,
